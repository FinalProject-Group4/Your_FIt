               ...
               <div class="topmenu text-right">
                  <ul class="list-inline">
                     ...
                     <c:otherwise>
                        ...
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/member/Logout.do">로그아웃</a></li>
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/mypage/memberMypage.do?m_Id=${member.m_Id}">마이페이지</a></li>
            ...
            <div class="collapse navbar-collapse" id="cloapediamenu">
               <ul class="navbar-nav col-12">
                        ...
                        <li class="nav-item" id="nav_li03"><a
                           class="nav-link color-pink-hover" href="${pageContext.request.contextPath}/cbBoard/cbBoard.do" id="dropdown03">칼로리
                              사전</a></li>
                        ...
                        <li class="nav-item" id="nav_li05">
                        	<a class="nav-link color-pink-hover" href="#" id="dropdown05">쇼핑몰</a>
                        </li>
               </ul>
            </div>
         </nav>         
