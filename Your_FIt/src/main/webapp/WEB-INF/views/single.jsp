...
<html lang="en">
    ...
    <link href="${pageContext.request.contextPath}/resources/css/colors.css" rel="stylesheet">
...
<body>
    ...
    <!-- LOADER -->
    <div id="preloader">
        <img class="preloader" src="${pageContext.request.contextPath}/resources/images/loader.gif" alt="">
    </div><!-- end loader -->
    <!-- END LOADER -->
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_01.jpg" alt="" class="img-fluid">
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_02.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_03.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                                        <span class="menucat">Beauty</span>
                                                                    </a>
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_04.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                                        <span class="menucat">Spa</span>
                                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_05.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/upload/menu_06.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_07.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                                        <span class="menucat">Fashion</span>
                                                                    </a>
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_08.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_09.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_11.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_12.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_13.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                                        <span class="menucat">Tourism</span>
                                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_14.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_15.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_16.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_17.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_18.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_19.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_20.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="${pageContext.request.contextPath}/resources/upload/menu_21.jpg" alt="" class="img-fluid">
                                                                        <div class="hovereffect">
                                                                        </div><!-- end hover -->
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="blog-content">  
                                ...
                                <img src="${pageContext.request.contextPath}/resources/upload/menu_05.jpg" alt="" class="img-fluid img-fullwidth">
                                            ...
                                            <div class="list-group">
                                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="${pageContext.request.contextPath}/resources/upload/blog_square_02.jpg" alt="" class="img-fluid float-right">
                                            ...
                                            <div class="list-group">
                                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between">
                                                        <img src="${pageContext.request.contextPath}/resources/upload/blog_square_03.jpg" alt="" class="img-fluid float-left">
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <img src="${pageContext.request.contextPath}/resources/upload/author.jpg" alt="" class="img-fluid rounded-circle"> 
                                    </div><!-- end col -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            <div class="post-media">
                                                <a href="single.html" title="">
                                                    <img src="${pageContext.request.contextPath}/resources/upload/menu_06.jpg" alt="" class="img-fluid">
                                                    <div class="hovereffect">
                                                        <span class=""></span>
                                                    </div><!-- end hover -->
                                                </a>
                                        ...
                                        <div class="comments-list">
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="${pageContext.request.contextPath}/resources/upload/author.jpg" alt="" class="rounded-circle">
                                                </a>
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="${pageContext.request.contextPath}/resources/upload/author_01.jpg" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media last-child">
                                                <a class="media-left" href="#">
                                                    <img src="${pageContext.request.contextPath}/resources/upload/author_02.jpg" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <div class="blog-list-widget">
                                    <div class="list-group">
                                        <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between">
                                                <img src="${pageContext.request.contextPath}/resources/upload/blog_square_01.jpg" alt="" class="img-fluid float-left">
                                                <h5 class="mb-1">5 Beautiful buildings you need to before dying</h5>
                                        ...
                                        <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between">
                                                <img src="${pageContext.request.contextPath}/resources/upload/blog_square_02.jpg" alt="" class="img-fluid float-left">
                            ...
                            <div class="widget">
                                ...
                                <div class="banner-spot clearfix">
                                    <div class="banner-img">
                                        <img src="${pageContext.request.contextPath}/resources/upload/banner_03.jpg" alt="" class="img-fluid">
                                    </div><!-- end banner-img -->
                                </div><!-- end banner -->
                            </div><!-- end widget -->
                            ...
                            <div class="widget">
                                ...
                                <div class="instagram-wrapper clearfix">
                                    <a class="" href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_01.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_02.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_03.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_04.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_05.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_06.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_07.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_08.jpeg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/upload/insta_09.jpeg" alt="" class="img-fluid"></a>
                        ...
                        <div class="widget">
                            ...
                            <div class="blog-list-widget">
                                <div class="list-group">
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="${pageContext.request.contextPath}/resources/upload/blog_square_04.jpg" alt="" class="img-fluid float-left">
                                    ...
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="${pageContext.request.contextPath}/resources/upload/blog_square_07.jpg" alt="" class="img-fluid float-left">
                                    ...
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="${pageContext.request.contextPath}/resources/upload/blog_square_06.jpg" alt="" class="img-fluid float-left">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="index.html"><img src="${pageContext.request.contextPath}/resources/images/flogo.png" alt="" class="img-fluid"></a>
